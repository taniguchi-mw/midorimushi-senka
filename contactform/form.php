...
//エラーチェック
if($_POST[name]==""){ $er.="■お名前が入力されておりません。<br />"; }
if($_POST[kana]==""){ $er.="■フリガナが入力されておりません。<br />"; }
...
if($_POST[sousin_x]!=""){
	...
	$subject="【自動返信確認メール】【ミドリムシ専科】お問い合わせいただきありがとうございます。";
	...
	$body.=$name."様\n";
	$body.="この度は、ミドリムシ専科へ\n";
	$body.="お問い合わせ頂きまして、誠にありがとうございます。\n\n";
	$body.="弊社営業日中にメールか電話にて回答させて頂きます。\n";
	$body.="ご入力頂いたメールアドレスに返信致しますのでしばらくお待ちください。\n";
	$body.="ご不明な点がございましたら、\n";
	$body.="ミドリムシ専科運営　株式会社ユーコネクトまでご連絡をお願い致します。\n";
	$body.="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
	$body.="お問い合わせ内容\n";
	$body.="**********************************************************************\n";
	$body.="■お名前：\n";
	...
	$subject="【問い合わせ】ミドリムシ専科への問い合わせがありました！";
	$subject=mb_convert_encoding($subject,"JIS","utf-8");
	$subject=base64_encode($subject);
	$subject="=?iso-2022-jp?B?".$subject."?=";
...
<title>お問い合わせフォーム　｜　ミドリムシ専科</title>
<script>
    ...
    <div class="conbox900">
      ...
      <div class="formbox">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            <tr>
              <th><span class="fc-redb">※</span>お名前</th>
              <td><input name="name" type="text" class="text" value="<?php echo $name; ?>" /></td>
            </tr>
            <tr>
              <th><span class="fc-redb">※</span>フリガナ</th>
            ...
            <tr>
              <th><span class="fc-redb">※</span>お問い合わせ内容</th>
