...
if($_POST[sousin_x]!="" and $er!=""){
?>
      <p align="center" style="color:#FF0000; font-weight:bold;"><? echo $er; ?></p>
      <?
}
//入力画面用
...
?>
      ...
      <p align="center">
        <input name="mail" type="text" id="mail" size="40" value="<? echo htmlspecialchars($_POST['mail']); ?>" style="ime-mode:disabled;height:20px;" />
      </p>
