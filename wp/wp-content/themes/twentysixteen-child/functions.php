...
if (!is_admin()) {
	function register_script(){
		...
		wp_register_script('all',  home_url().'/js/all.js');
		wp_register_script('gotosp',  home_url().'/js/gotosp.js');
		wp_register_script('rollover',  home_url().'/js/rollover.js?type=_on');
		wp_register_script('colorbox',  home_url().'/js/jquery.colorbox-min.js');
...
if (!is_admin()) {
	function register_style() {
		wp_register_style('import', home_url().'/css/import.css');
